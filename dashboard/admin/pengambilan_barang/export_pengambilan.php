...
if (empty($cabang_admin) || $id_cabang_admin == 0) {
    die("Cabang admin tidak ditemukan di session.");
}
...
$stmt->bind_param('si', $tanggal, $id_cabang_admin);
$stmt->execute();
...
$filename = "Pengambilan_Barang_" . $cabang_admin . "_" . date('d-m-Y', strtotime($tanggal)) . ".xls";
