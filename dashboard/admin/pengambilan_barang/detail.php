...
if(isset($_GET['id'])) {
    ...
    $stmt->bind_param('ii', $id, $id_cabang_admin);
    $stmt->execute();
    ...
    if (!$pengiriman || !in_array($pengiriman['status'], ['sampai tujuan', 'pod'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    // Simpan data ke tabel pengambilan
