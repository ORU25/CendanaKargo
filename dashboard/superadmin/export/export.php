...
$stmtTransfer->bind_param('ss', $username, $username);
...
$stmtbayar_ditempat->bind_param('s', $username);
...
echo "<tr><td colspan='15' style='background:#fff3cd; font-style:italic;'>Cash dari admin ini + BT POD yang dibuat admin ini</td></tr>";
