...
// ======================================================
// PROSES KONFIRMASI PENGAMBILAN BARANG (DENGAN LOG STATUS)
// ======================================================
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($id_update > 0) {
        // Ambil data pengiriman untuk log
        ...
        $status_baru = 'POD'; // Gunakan huruf besar agar cocok dengan ENUM DB
...
if (isset($_GET['id'])) {
    ...
    if (!$pengiriman || strtolower($pengiriman['status']) !== 'sampai tujuan') {
        header("Location: ./?error=not_found");
        exit;
    }
}

$title = "Detail Pengambilan Barang - Cendana Kargo (Superadmin)";
