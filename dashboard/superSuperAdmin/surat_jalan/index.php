...
if (!empty($search)) {
    $search_param = "%$search%";
    $stmt_sj->bind_param('ssssii', $search_param, $search_param, $search_param, $search_param, $limit, $offset);
} else {
    $stmt_sj->bind_param('ii', $limit, $offset);
}
$stmt_sj->execute();
            ...
            <form id="formPilihCabang" method="POST" action="create.php">
                ...
                <div class="modal-body p-4">
                    <p class="text-muted small mb-4">
                        Pilih cabang asal dan tujuan untuk membuat surat jalan baru.
                    </p>
