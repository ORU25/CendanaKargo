...
$stmtTransfer->bind_param('s', $cabang);
...
echo "<tr style='background:#0d6efd; color:white; font-weight:bold;'>
        <th colspan='15'>LAPORAN PENDAPATAN TRANSFER - CABANG " . strtoupper($cabang) . "</th>
      </tr>";
echo "<tr><td colspan='15' style='background:#cfe2ff;'>Periode: " . htmlspecialchars($periode_display) . "</td></tr>";
echo "<tr><td colspan='15' style='background:#fff3cd; font-style:italic;'>Transfer dari cabang ini</td></tr>";
